...
namespace Patents.ArtRepoCloud.Service.EventBusSettings
{
    ...
    internal class ArtRepoServiceBusLowPriorityQueueSettings : IPriorityEventBusQueueSettings
    {
        private readonly ServiceBusSettings _appSettings;

        public ArtRepoServiceBusLowPriorityQueueSettings(ServiceBusSettings appSettings)
        {
        ...
        public string QueueName => _appSettings.ArtRepoQueue.LowPriority;
