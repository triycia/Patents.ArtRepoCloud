...
namespace Patents.ArtRepoCloud.Service.EventBusSettings
{
    ...
    public class PAIRServiceBusLowPriorityQueueSettings : IPriorityEventBusQueueSettings
    {
        private readonly ServiceBusSettings _appSettings;

        public PAIRServiceBusLowPriorityQueueSettings(ServiceBusSettings appSettings)
        {
        ...
        public string QueueName => _appSettings.PAIRQueue.LowPriority;
