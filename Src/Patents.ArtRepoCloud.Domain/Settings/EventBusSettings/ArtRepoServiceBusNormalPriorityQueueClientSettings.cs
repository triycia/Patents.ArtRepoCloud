...
namespace Patents.ArtRepoCloud.Domain.Settings.EventBusSettings
{
    ...
    public class ArtRepoServiceBusNormalPriorityQueueClientSettings : IEventBusQueueClientSettings
    {
        private readonly ServiceBusSettings _serviceBusSettings;

        public ArtRepoServiceBusNormalPriorityQueueClientSettings(ServiceBusSettings serviceBusSettings)
        {
        ...
        public string QueueName => _serviceBusSettings.ArtRepoQueue.NormalPriority;
    }
}