...
namespace Patents.ArtRepoCloud.Domain.Settings.EventBusSettings
{
    ...
    public class ArtRepoServiceBusIdlePriorityQueueClientSettings : IEventBusQueueClientSettings
    {
        private readonly ServiceBusSettings _serviceBusSettings;

        public ArtRepoServiceBusIdlePriorityQueueClientSettings(ServiceBusSettings serviceBusSettings)
        {
        ...
        public string QueueName => _serviceBusSettings.ArtRepoQueue.IdlePriority;
    }
}